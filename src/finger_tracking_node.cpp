...
//    rightCameraInfoSubscriber_.subscribe(nh, "/kitty_stereo/right/camera_info", 10);
    ...
    publisher_ = imageTransport_.advertise("output", 1);
...
//        //Convert the CvImage to a ROS image message and publish it to output topic.
//        cv_bridge::CvImage out_msg;
//        out_msg.encoding = sensor_msgs::image_encodings::MONO8;
//        out_msg.image    = img_matches;
//        out_msg.header.seq = seq;
//        out_msg.header.frame_id = seq;
//        out_msg.header.stamp = ros::Time::now();
//        publisher_.publish(out_msg.toImageMsg());

//        cv_bridge::CvImage out_msg_dis;
//        disparity_Map.convertTo(disparity_Map, CV_8UC1);
//        out_msg_dis.encoding = sensor_msgs::image_encodings::MONO8;
//        out_msg_dis.image    = disparity_Map;
//        out_msg_dis.header.seq = seq;
//        out_msg_dis.header.frame_id = seq;
//        out_msg_dis.header.stamp = ros::Time::now();
//        disparity_publisher_.publish(out_msg_dis.toImageMsg());




//        //prepare for next call back
//        lastSeq=seq;

        
//        ROS_INFO("______________________________________________");
